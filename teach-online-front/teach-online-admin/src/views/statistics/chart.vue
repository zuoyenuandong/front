<template>
  <div class="app-container">
    ...
    <el-row>
      <el-col :span="12">
        <div id="register_num" class="chart" style="height:500px;" ></div>
      </el-col>
      <el-col :span="12">
        <div id="login_num" class="chart" style="height:500px;" ></div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <div id="video_view_num" class="chart" style="height:500px;" ></div>
      </el-col>
      <el-col :span="12">
        <div id="course_num" class="chart" style="height:500px;" ></div>
      </el-col>
    </el-row>
  </div>
</template>
